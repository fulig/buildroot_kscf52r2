...
/*
 *  kscf52xxsim.h -- University of Kassel Safety SoC based on CFv2SPP5208
 *  System Integration Module support.
 *  2018, Waldemar Müller (waldemar@wmtx.de)
 * 
...
#define CPU_NAME    "COLDFIRE_SPP5208"
...
#define MCFINT_TIMER         32    /* Timer0  */
#define MCFINT_PROFILER      33    /* Timer1 */
...
#define MCF_IRQ_TIMER     (MCFINT_VECBASE + MCFINT_TIMER)
#define MCF_IRQ_PROFILER  (MCFINT_VECBASE + MCFINT_PROFILER)
